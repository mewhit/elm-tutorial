module Editor.Ui.Package exposing (..)

import Dict
import Editor.Data.Analytics as Analytics
import Editor.Data.Fetched as Fetched
import Editor.Data.Http
import Editor.Data.Problem as Problem
import Editor.Data.Registry as Registry
...
import Editor.Data.Registry.Status as Status
...
getProblems model =
    Registry.getErrors (getRegistry model)
        |> List.filterMap Editor.Data.Http.onlyDecodedErrors
        -- TODO
    ...
    H.div
        ...
        [ H.div
          ...
          <|
            case model.registry of
                Fetched.Loading ->
                    [ Editor.Ui.Icon.simpleIcon [] Nothing Icon.loader ]

                Fetched.Failed err ->
                    [ H.div
                        [ HA.style "font-size" "12px" ]
                        [ Editor.Ui.Icon.simpleIcon [ HA.style "padding-right" "5px" ] (Just "red") Icon.alertCircle
            ...
            Status.DirectDep version ->
                viewOkPackage package
                    ...
                    , if List.member (Package.toKey package) Defaults.locked then
                        viewSimpleIcon Nothing Icon.lock

                      else
                        viewButtonIcon Nothing "Uninstall" Icon.trash (OnUninstall package)
                    ]
...
viewButtonIcon iconColor alt icon onClick =
    Editor.Ui.Icon.button [ HA.style "padding-left" "10px" ]
        { background = Nothing
        , icon = icon
        , iconColor = iconColor
        , label = Nothing
